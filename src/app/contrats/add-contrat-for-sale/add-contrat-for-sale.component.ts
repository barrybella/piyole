...
export class AddContratForSaleComponent implements OnInit {
  ...
  /**
   * Traite et enregistre les données fournies.
   */
  submitSale(){
  ...
  /**
   * Exécute le traitement associé à la méthode « fileProgressCarte ». 
   */
  ...
  /**
   * Exécute le traitement associé à la méthode « calculMont ». 
   */
  calculMont(){
    var post = this.post;
    this.montant = 0;
  ...
  /**
   * Met à jour les données ou l’état du composant.
   */
