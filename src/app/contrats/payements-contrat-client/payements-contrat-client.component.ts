...
@Component({
  selector: 'app-payements-contrat-client',
  templateUrl: './payements-contrat-client.component.html',
  styleUrls: ['./payements-contrat-client.component.css']
})
export class PayementsContratClientComponent implements OnInit {
  contrat?: Contrat;
  year_tab_now?: any;
  year_iter?: any = 0;
  ...
  getContrat(){
    ...
    this.contratService.getContratForClient(id).subscribe(res => {
      this.contrat = res;
      if(!this.is_iter){
