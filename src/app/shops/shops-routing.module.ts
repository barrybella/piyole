...
// Table de routage du module "shops" : boutique/catalogue (shopping), gestion des
// produits (liste, ajout, modification, corbeille), détail produit, résultats de
// recherche pour une boutique donnée, et liste du panier.
const routes: Routes = [
