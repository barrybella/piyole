...
// Formulaire de finalisation de commande : demande l'adresse de livraison, puis
// crée la commande à partir du contenu du panier et du montant total transmis
...
export class AddCommandeComponent implements OnInit {
  ...
  // Formulaire réactif : seule l'adresse de livraison est saisie manuellement,
  // le montant et le contenu du panier étant injectés automatiquement à la soumission.
  ...
  // Complète le formulaire avec le montant total et le contenu du panier (transmis
  // via les données de la boîte de dialogue), crée la commande, affiche une
  // confirmation, ferme la boîte de dialogue et redirige vers la liste des commandes.
  onSubmit(){
