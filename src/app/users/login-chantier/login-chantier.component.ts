...
// Variante de connexion, ouverte en boîte de dialogue depuis le contexte de suivi
// de chantier : une fois connecté, enchaîne directement sur l'ouverture du
// formulaire d'ajout d'un chantier (AddChantierComponent).
@Component({
...
export class LoginChantierComponent implements OnInit {
  ...
  // boîtes de dialogue ouvertes puis rouvre directement celle d'ajout de chantier,
  // pour continuer le parcours entamé par l'utilisateur sans interruption.
  onSubmit(){
