...
// Variante du formulaire d'inscription, utilisée depuis le contexte d'une boutique :
// même formulaire que RegisterComponent, mais à la fin de l'inscription, ouvre
// directement le panier d'achat de la boutique concernée plutôt que de rediriger
// vers le profil.
@Component({
...
export class RegisterShopComponent implements OnInit {
  ...
  // (nom, téléphone/email validés en temps réel, mot de passe).
  ...
  // directement celle du panier pour la boutique concernée (redirection vers le
  // profil désactivée/commentée au profit de ce parcours).
  onSubmit(){
  ...
  // Retourne le message d'erreur pour le champ code (indicatif pays) s'il est vide.
  getCodeError(){
