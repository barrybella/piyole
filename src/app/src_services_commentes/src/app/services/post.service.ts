...
// Service central de gestion des annonces (posts) : création, mise à jour, suppression
...
export class PostService {
  ...
  // public getPostsByCategoryForRent(categorie: string, limit: number = 1000000000): Observable<Post[]>{
  //   return this.http.get<Post[]>(`${this.api}/getPostsByCategoryForRent/${categorie}/${limit}`).pipe(
  //     retry(3),      
  //   )
  // }

  // public getPostsByCategoryForSale(categorie: string, limit: number = 1000000000): Observable<Post[]>{
  ...
  // type, catégorie et fourchette de prix (min/max), avec pagination.
  ...
  // public getPostByPostIdLocationAndVente(postId: any): Observable<Post>{
  //   return this.http.get<Post>(`${this.api}/getPostByPostIdLocationAndVente/${postId}`).pipe(
  //     retry(3),      
  //   )
  // }
