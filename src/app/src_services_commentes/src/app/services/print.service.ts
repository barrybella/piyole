...
export class PrintService {
  // public categories: string[] = ["Appatement", "Maison Habitation", "Maison Luxe", "Entrer Coucher", "Villa", "Duplex", "Triplex", "Imeuble", "Studio", "Usage Multiple", "Ecole ou Universitée", "Bureaux", "Boutique", "Magasin Stock", "Autre"];
  ...
  printVideo(video: any){
    console.log("VIDEO ",baseUrl, video);
  ...
  printDayNotPay(contrat: any): any{
    ...
    // var days = date.getTime() - end_date.getTime();
    if(date > end_date){
      ...
      // var diffDays = Math.abs(date.getTime() - end_date.getTime()) / 3600000;
      ...
      hours = date.getTime() - end_date.getTime();
      // var diffDays_verifie = Math.abs(date.getTime() - end_date.getTime()) / 3600000;
