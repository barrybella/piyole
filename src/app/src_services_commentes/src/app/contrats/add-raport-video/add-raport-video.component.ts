...
@Component({
  selector: 'app-add-raport-video',
  templateUrl: './add-raport-video.component.html',
  styleUrls: ['./add-raport-video.component.css']
})
export class AddRaportVideoComponent implements OnInit {
  user?: User;
  etatPadding: boolean = false;
  contrat: any;
  mont_diff: any = 0;

  constructor(public dialogRef: MatDialogRef<AddRaportVideoComponent>,
