...
@Component({
  selector: 'app-list-contrat-journalier',
  templateUrl: './list-contrat-journalier.component.html',
  styleUrls: ['./list-contrat-journalier.component.css']
})
export class ListContratJournalierComponent implements OnInit, OnDestroy {
  contrats: Contrat[] = [];
  post?: any;
  p: number = 1;
  ...
  getContrats(){
    ...
    this.contratService.getContratJournaliers().subscribe(res => {
      this.contrats = res;
