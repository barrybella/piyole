...
export class AddPlanComponent implements OnInit {
  ...
  //   this.s3Service.uploadImages(files)
  //     .then(urls => {
  //       console.log('URLs des images sur S3 :', urls);
  //       // Vous pouvez maintenant utiliser ces URLs comme nécessaire
  //     })
  ...
  onSubmit(){
    ...
    // const urls: string[] = [
    //   'https://piyole-bucket.s3.eu-north-1.amazonaws.com/images/1714751683470-03.jpg',
    //   'https://piyole-bucket.s3.eu-north-1.amazonaws.com/images/1714751683469-01.png',
    //   'https://piyole-bucket.s3.eu-north-1.amazonaws.com/images/1714751683471-03.png',
    //   'https://piyole-bucket.s3.eu-north-1.amazonaws.com/images/1714751683457-01%20%281%29.png',
    //   'https://piyole-bucket.s3.eu-north-1.amazonaws.com/images/1714751683470-03%20%281%29.png'
    // ];
    
    // const partiesImages: string[] = urls.map(url => url.slice(url.indexOf('/piyole-bucket.s3.eu-north-1.amazonaws.com/') + '/piyole-bucket.s3.eu-north-1.amazonaws.com/'.length));
    
    // console.log(partiesImages);
  ...
  //   const regex = new RegExp(`^images/${letter}`, 'i'); // Créer une expression régulière pour rechercher les éléments commençant par la lettre spécifiée
  //   return tabs.filter(tab => regex.test(tab)); // Filtrer les éléments qui correspondent à l'expression régulière
  // }
